...
const AdminAnalytics = () => {
    ...
    return (
            ...
            <div className="container mx-auto px-4 py-8">
                <h2 className="text-3xl font-bold text-center mb-8 text-gray-800">Student Analytics</h2>
    
                {/* Row 1: Placement Rate Doughnut Chart + Branch Pie Chart */}
                <div className="flex flex-wrap justify-center gap-6 mb-8">
                    {/* Placement Rate Doughnut Chart */}
                    <div className="w-full sm:w-1/2 lg:w-2/5 p-4">
                        <h3 className="text-2xl font-semibold text-center mb-4 text-blue-800">Placement Rate</h3>
                        <div className="bg-gradient-to-br from-blue-200 to-blue-400 p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out">
                    ...
                    {/* Branch Pie Chart */}
                    <div className="w-full sm:w-1/2 lg:w-2/5 p-4">
                        <h3 className="text-2xl font-semibold text-center mb-4 text-blue-800">Students by Branch</h3>
                        <div className="bg-gradient-to-br from-green-200 to-green-400 p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out">
                ...
                <div className="flex justify-center mb-8">
                    <div className="w-full sm:w-3/4 lg:w-2/3 xl:w-3/4 p-4">
                        <h3 className="text-2xl font-semibold text-center mb-4 text-purple-800">Applications Over Time</h3>
                        <div className="bg-gradient-to-br from-purple-200 to-purple-400 p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out">
                            <Line data={linechartData} options={linechartOptions} height={220} width={600} />
                        </div>
                    </div>
                </div>
    
                {/* Row 3: CGPA Distribution Bar Chart */}
                <div className="flex justify-center mb-8">
                    <div className="w-full sm:w-3/4 lg:w-2/3 p-4">
                        <h3 className="text-2xl font-semibold text-center mb-4 text-red-800">CGPA Distribution</h3>
                        <div className="bg-gradient-to-br from-red-200 to-red-400 p-6 rounded-lg shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-300 ease-in-out">
